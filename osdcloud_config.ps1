...
Then make sure your `Edit-OSDCloudWinPE` command in the USB builder script is pointing to **your** GitHub raw URL, not TechVertu's. It should look something like:
```
https://raw.githubusercontent.com/YourUsername/YourRepo/refs/heads/main/osdcloud_config.ps1
